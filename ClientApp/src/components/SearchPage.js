...
let data = [
  ...
  },
  {
    ...
    Poster:
      "https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_QL50_.jpg",
    SoundEffects: ["RX6", "SDDS"],
    Stills: [
...
export class Search extends Component {
  ...
  searchChangeHandler(event) {
    ...
    result = data.filter((d) => {
      return d.Title.toLowerCase().search(value) != -1;
    });
      ...
      <>
        <table className="titleBar">
          <tbody>
            <tr>
              <td>
                <img alt="app icon" width="50" src="/movie_logo.jpg" />
              </td>
              <td width="8" />
              <td>
